...
export function AdvertisementForm() {
  ...
  const downloadExcel = () => {
    ...
    link.setAttribute(
      "download",
      `advertisements_${new Date().toISOString().split("T")[0]}.csv`
    );
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                  {cities.map((city) => (
                    <label
                      key={city.id}
                      className="flex items-center space-x-2 cursor-pointer hover:bg-white rounded p-2 transition-colors duration-150"
                    >
                      <input
                        type="checkbox"
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Manage your existing advertisements
                </p>
              </div>
