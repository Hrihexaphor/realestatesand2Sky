    ...
    <div className="w-full flex flex-col h-full bg-white p-6 rounded-xl shadow-sm">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          <SearchBox placeholder="Search properties..." containerClassName="w-full md:w-64" className="w-full bg-gray-100 rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all"/>
