...
export async function addToFeatured(property_id, start_date, end_date) {
  const result = await pool.query(
    `INSERT INTO featured_properties (property_id, featured_from, featured_to) VALUES ($1, $2, $3) RETURNING *`,
